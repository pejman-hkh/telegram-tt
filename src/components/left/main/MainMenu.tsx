import React, { FC, memo, StateHookSetter, useMemo } from "../../../lib/teact/teact";
...
const MainMenu: FC<OwnProps & StateProps> = ({ content, setContent, onReset, shouldSkipTransition, shouldHideSearch, className }) => {
